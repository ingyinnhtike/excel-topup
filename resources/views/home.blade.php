...
@section('title', 'Top-up Dashboard')
@section('content')
                                ...
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <h6 class="font-extrabold mb-0" style="font-size: 18px;">{{ $currMonthBillTotal }} <small>MMK</small></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <h6 class="font-extrabold mb-0" style="font-size: 18px;">{{ $currMonthDataTotal }} <small>MMK</small></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
