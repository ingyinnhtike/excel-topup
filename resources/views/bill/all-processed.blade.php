    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">All Processed Bill</h4>
            </div>
            <div class="card-body">
                <form role="form" action="{{ url('all-bill-filter') }}" method="post" class="mb-3">
                    @csrf
                    <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table" style="width:100%" id="allbillProcessed">
                    <thead>
                    <tr>
                        <th>No</th>
                        <th>Phone Number</th>
