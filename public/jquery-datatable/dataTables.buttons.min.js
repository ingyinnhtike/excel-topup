                ...
                if (n)
                    if (Array.isArray(n)) this._expandButton(a, n, c, d);
                        ...
                        k &&
                            ...
                            n.init &&
                                n.init.call(f.button(k.node), f, e(k.node), n),
                            h++);
                    }
            }
        },
        ...
        _resolveExtends: function (a) {
            var b = this.s.dt,
                ...
                d = function (g) {
                    for (
                        var n = 0;
                        !e.isPlainObject(g) && !Array.isArray(g);
                ...
                f = function (g, n) {
                    ...
                    if (Array.isArray(g) || g instanceof e)
                        ...
                        if (-1 !== g.indexOf(","))
                            ...
                            for (
                                g = g.replace(":name", ""), l = 0, k = p.length;
                                l < k;
                                l++
                            )
                                p[l].name === g &&
            ...
            function (d) {
                if (d._buttons)
                    return t.buttonSelector(
                        t.instanceSelector(a, d._buttons),
                        b
                    );
            },
            !0
